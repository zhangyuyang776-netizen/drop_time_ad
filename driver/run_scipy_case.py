...
def run_case(cfg_path: str, *, max_steps: Optional[int] = None, log_level: int | str = logging.INFO) -> int:
    """Deprecated wrapper; use driver/run_evap_case.py instead."""
    from driver.run_evap_case import run_case as run_evap_case

    return run_evap_case(cfg_path, max_steps=max_steps, log_level=log_level)
    # Legacy implementation kept below for reference; unreachable by design.
    level = log_level
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    logger.warning("Deprecated: use driver/run_evap_case.py instead.")
