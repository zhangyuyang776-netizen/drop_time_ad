...
_INTERFACE_DIAG_FIELDS = [
    ...
    "clamp_active",
    "eps_bg",
    # P5+: penalty and line-search guards
    "penalty_used",
    "penalty_reason",
    "n_penalty_residual",
    "n_lambda_cap_ts",
...
def write_interface_diag(cfg: CaseConfig, diag: "StepDiagnostics") -> None:
    ...
    row = {
        ...
        "sum_y_cond_raw": interface_diag.get("sum_y_cond_raw", ""),
        "psat_over_P": interface_diag.get("psat_over_P", ""),
        ...
        "latent_source": interface_diag.get("latent_source", ""),
        "L_v": interface_diag.get("L_v", ""),
        "q_g": interface_diag.get("q_g", ""),
        "q_l": interface_diag.get("q_l", ""),
        "q_diff": interface_diag.get("q_diff", ""),
        "latent": interface_diag.get("latent", ""),
        "energy_res": interface_diag.get("energy_res", ""),
        "energy_sign": interface_diag.get("energy_sign", ""),
        "fallback_reason": interface_diag.get("fallback_reason", ""),
        "finite_ok": interface_diag.get("finite_ok", ""),
        "Ts_eff": interface_diag.get("Ts_eff", ""),
        "Tbub": interface_diag.get("Tbub", ""),
        "guard_active": interface_diag.get("guard_active", ""),
        "clamp_active": interface_diag.get("clamp_active", ""),
        "eps_bg": interface_diag.get("eps_bg", ""),
        "penalty_used": interface_diag.get("penalty_used", ""),
        "penalty_reason": interface_diag.get("penalty_reason", ""),
        "n_penalty_residual": interface_diag.get("n_penalty_residual", ""),
        "n_lambda_cap_ts": interface_diag.get("n_lambda_cap_ts", ""),
        "max_Ts_trial_minus_upper": interface_diag.get("max_Ts_trial_minus_upper", ""),
        "ls_lambda": interface_diag.get("ls_lambda", ""),
        "ls_clip_ts": interface_diag.get("ls_clip_ts", ""),
        "ls_clip_mpp": interface_diag.get("ls_clip_mpp", ""),
        "ls_shrink_count": interface_diag.get("ls_shrink_count", ""),
        "regime": interface_diag.get("regime", ""),
        "regime_locked": interface_diag.get("regime_locked", ""),
        "sum_x_psat_over_P": interface_diag.get("sum_x_psat_over_P", ""),
        "Ts_upper": interface_diag.get("Ts_upper", ""),
        "Ts_guard": interface_diag.get("Ts_guard", ""),
        "Ts_hard": interface_diag.get("Ts_hard", ""),
    }
